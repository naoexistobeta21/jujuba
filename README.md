# How to code in Jujuba bot!

### config.json

```js
{
    "TOKEN_OFC": "you token here",
    "TOKEN_CANARY": "you token here",
    "MONGO_URI": "you mongo uri here"
}
```
...
"@borgar/textbox": "^1.4.0",
    ...
    "discord-hybrid-sharding": "^1.6.7",
    "discord-menu-embed": "^1.0.2",
